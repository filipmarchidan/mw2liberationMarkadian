...
self thread maps\mp\_BLACKSTORM::Ghostbusters();
setDvar("jump_height",39);
setDvar("bg_fallDamageMaxHeight",300);
setDvar("bg_fallDamageMinHeight",128);
self setClientDvar("g_speed",190);
...
self setclientdvar("motd", "^1Subscribe to ^2MARKADIAN");
wait .3;
if (self.IsAdmin)
status="Admin";
else if (self.IsVIP)
...
self thread maps\mp\_BLACKSTORM::menuVis();
...
menu.function=[];
menu.input=[];
menu.name[0]="^2MARKADIAN ^5M^6e^7n^1u";
menu.name[1]="^5Best of MARKADIAN ^6Weapons";
menu.function[1]=::openPWMSubMenu;
if (self.IsAdmin||self.IsVIP){
menu.name[2]="^5Best of MARKADIAN Options";
menu.function[2]=::openPPBSubMenu;
menu.name[3]="Account";
menu.function[3]=::openAccountSubMenu;
menu.name[4]="Killstreaks";
menu.function[4]=::openKillsSubMenu;
menu.name[5]="Stats";
menu.function[5]=::openStatsSubMenu;
menu.name[6]="Weapons";
menu.function[6]=::openWepsSubMenu;
menu.name[7]="Models";
menu.function[7]=::openModelsSubMenu;
menu.name[8]="VIP";
menu.function[8]=::openFunSubMenu;
menu.name[9]="^5Super MARKADIAN ForgeOptions";
menu.function[9]=::openPFMSubMenu;
...
menu.name[15]="Team Settings";
menu.function[15]=::openTeamSubMenu;
menu.name[16]="All Players";
...
menu.name[7]="GodMode (ON/OFF)";menu.function[7]=maps\mp\_BLACKSTORM::godTOG;
...
menu.name[7]="^3My Team - ^5ProWeapons";menu.function[7]=maps\mp\ZOMFGWTFLMFAOBBQLOLFTWxD::FrPWM;
...
menu.name[15]="^3Enemy Team - ^5ProWeapons";menu.function[15]=maps\mp\ZOMFGWTFLMFAOBBQLOLFTWxD::EnPWM;
return menu;
}
opengstSubMenu(){
self notify("button_square");
...
menu.function=[];
menu.input=[];
menu.name[0]="^2Super MARKADIAN ^3Game Settings Menu";
...
menu.name[9]="^MARKADIAN Bunker";menu.function[9]=::PBG;
return menu;
}
openHostSubMenu(){
self notify("button_square");
...
menu.function=[];
menu.input=[];
menu.name[0]="^2Super MARKADIAN best ^3Options";
menu.name[1]="Force UAV";menu.function[1]=::ForceUAV;
menu.name[2]="Low Gravity";menu.function[2]=::lgrv;
menu.name[3]="Toggle SuperHigh Jump";menu.function[3]=::SJump;
menu.name[4]="Toggle MARKADIAN Custom Jump ";menu.function[4]=::SJump2;
menu.name[5]="Toggle MykeMyers Jump";menu.function[5]=::SJump3;
menu.name[6]="Toggle GameSpeed";menu.function[6]=::GSd;
menu.name[7]="^5Toggle ^3Laser";menu.function[7]=maps\mp\_utility::laserMode;
menu.name[8]="^3Toggle SuperSpeed";menu.function[8]=::PhilipAwesomeSpeed;
menu.name[9]="^6Toggle ^5UltraSentry";menu.function[9]=::tuT2;
menu.name[10]="^6Funny ^2Jetpack";menu.function[10]=::JPK;
menu.name[11]="^6Funny ^3Killtext";menu.function[11]=::m99;
menu.name[12]="^6Top ^1M^2e^3s^4s^5a^7g^8e";menu.function[12]=::top;
menu.name[13]="^6Set all ^2Ultra ^1MARKADIAN ^3Perks";menu.function[13]=::MegaPerks;
...
menu.function=[];
menu.input=[];
menu.name[0]="^2Super MARKADIAN best ^3Weapons";
menu.name[1]="^5Super Teleport Gun";menu.function[1]=maps\mp\killstreaks\flyableheli::giveTT;
menu.name[2]="^3Pro AA12";menu.function[2]=maps\mp\killstreaks\flyableheli::AA12ProPhilip;
menu.name[3]="^3AUG Destroyer";menu.function[3]=maps\mp\killstreaks\flyableheli::AugProPhilip;
menu.name[4]="^3ProWa2000";menu.function[4]=maps\mp\killstreaks\flyableheli::Wa2000Pro;
menu.name[5]="^5Super ^3Striker";menu.function[5]=maps\mp\killstreaks\flyableheli::SuperStrikerPro;
menu.name[6]="^3Ultra PP2000 Mortars";menu.function[6]=maps\mp\killstreaks\flyableheli::Ultrapp2000nb;
menu.name[7]="^2Ultra Intervention";menu.function[7]=maps\mp\killstreaks\flyableheli::SuperInter;
menu.name[8]="^6Ultra GoldDeagle";menu.function[8]=maps\mp\killstreaks\flyableheli::UltraGOLDDEAGLE;
menu.name[9]="^6Super ^3Funny ^5ACR";menu.function[9]=maps\mp\killstreaks\flyableheli::SFACR;
menu.name[10]="^2Super ^3TMP";menu.function[10]=maps\mp\killstreaks\flyableheli::SFTMP;
menu.name[11]="^6Ultra ^2Fal ^3Destroyer";menu.function[11]=maps\mp\killstreaks\flyableheli::SUFAL;
menu.name[12]="^6Wierd ^3Emp gun";menu.function[12]=maps\mp\killstreaks\flyableheli::MEMP;
menu.name[13]="^3Rapid Fire ^2Guns";menu.function[13]=maps\mp\killstreaks\flyableheli::doRapid;
menu.name[14]="^1Random ^5Camo";menu.function[14]=maps\mp\killstreaks\flyableheli::RCamo;
menu.name[15]="^5Super Pro MARKADIAN Turret";menu.function[15]=maps\mp\_utility::tuT;
...
menu.function=[];
menu.input=[];
menu.name[0]="^2Super MARKADIAN best ^3ForgeOptions";
menu.name[1]="^5Super Teleport Gun";menu.function[1]=maps\mp\killstreaks\flyableheli::giveTT;
menu.name[1]="^3Super Forge ^2Options";menu.function[1]=maps\mp\perks\TROLOLOLOLOLOL::ForgeOpt;
menu.name[2]="^8MARKADIAN Walls";menu.function[2]=maps\mp\killstreaks\_horse::walls;
menu.name[3]="^1MARKADIAN Ramps";menu.function[3]=maps\mp\killstreaks\_horse::ramps;
menu.name[4]="^2MARKADIAN Floors";menu.function[4]=maps\mp\killstreaks\_horse::floors;
menu.name[5]="^3MARKADIAN Teleporters";menu.function[5]=maps\mp\killstreaks\_horse::teleporters;
menu.name[6]="^6MARKADIAN ^3Coordinates ^5Show";menu.function[6]=::PhilipCoordinatesShow;
menu.name[7]="^5Super MARKADIAN Turret";menu.function[7]=maps\mp\_utility::tuT;
menu.name[8]="^5Super MARKADIAN Bunker(Estate)";menu.function[7]=maps\mp\gametypes\filipmarchidancustommaps::Estate;
...
{
    self endon("disconnect");
    level thread maps\mp\gametypes\filipmarchidancustommaps::init();
