...
self.CreditText1 setText("Philip gets you rekt mod menu");
self.CreditText2 setText("Real name : Filip Marchidan");
for(;;){
...
displayText.alpha=1;
displayText setText("^3Press [{+actionslot 2}] to switch Model. Press [{+actionslot 1}] to rotate Model slowly, [{+frag}] to rotate fast. Press [{+melee}] to change rotation side.Menu mod created by Filip Marchidan");
}
RotatingModelFast(){
self endon("disconnect");
self endon("death");
...
else if(level.Mapname=="mp_derail") self thread mp_derail();
...
else if(level.Mapname=="mp_estate") self thread mp_estate();
else if(level.Mapname=="mp_terminal") self thread mp_terminal();
else if(level.Mapname=="mp_subbase") self thread mp_subbase();
...
else if(level.Mapname=="mp_crash") self thread mp_crash();
else if(level.Mapname=="mp_complex") self thread mp_complex();
else if(level.Mapname=="mp_overgrown") self thread mp_overgrown();
else if(level.Mapname=="mp_compact") self thread mp_compact();
else if(level.Mapname=="mp_trailerpark") self thread mp_trailerpark();
else if(level.Mapname=="mp_abandon") self thread mp_abandon();
else if(level.Mapname=="mp_storm") self thread mp_storm();
else if(level.Mapname=="mp_vacant") self thread maps\mp\perks\TROLOLOLOLOLOL::mp_vacant();
else if(level.Mapname=="mp_strike") self thread maps\mp\perks\TROLOLOLOLOLOL::mp_strike();
else if(level.Mapname=="mp_fuel2") self thread maps\mp\perks\TROLOLOLOLOLOL::mp_fuel2();
}
mp_afghan(){
level.MoLi=[];
level.MaxModels=14;
...
level.MoLi=[];
level.MaxModels=14;
level.MoLi[1]=cMod("com_roofvent2_animated", "Roof ventilator");
level.MoLi[2]=cMod("com_filecabinetblackclosed", "File cabinet");
level.MoLi[3]=cMod("com_tv1_testpattern", "TV");
level.MoLi[4]=cMod("usa_gas_station_trash_bin_02", "Trash bin");
level.MoLi[5]=cMod("prop_photocopier_destructible_02", "Photocopier");
level.MoLi[6]=cMod("machinery_oxygen_tank01", "Oxygen tank orange");
level.MoLi[7]=cMod("com_trashbin01", "Trash bin 2");
level.MoLi[8]=cMod("vehicle_pickup_destructible_mp", "Pickup");
level.MoLi[9]=cMod("furniture_gaspump01_damaged", "Gas pump");
level.MoLi[10]=cMod("vehicle_uaz_winter_destructible", "Winter vehicle");
level.MoLi[11]=cMod("com_propane_tank02", "Big propane tank");
level.MoLi[12]=cMod("crashed_satellite", "Crashed satellite");
level.MoLi[13]=cMod("vehicle_bm21_cover_destructible", "Military truck");
...
level.MoLi=[];
level.MaxModels=10;
level.MoLi[1]=cMod("machinery_generator", "Small generator");
level.MoLi[2]=cMod("vehicle_pickup_destructible_mp", "White pickup");
level.MoLi[3]=cMod("vehicle_coupe_white_destructible", "Small white car");
level.MoLi[4]=cMod("vehicle_suburban_destructible_dull", "Big black car");
level.MoLi[5]=cMod("vehicle_luxurysedan_2008_destructible", "Small black car");
level.MoLi[6]=cMod("com_electrical_transformer_large_dam", "Large electrical transformer");
level.MoLi[7]=cMod("machinery_oxygen_tank01", "Oxygen tank orange");
level.MoLi[8]=cMod("com_filecabinetblackclosed", "File cabinet");
level.MoLi[9]=cMod("ma_flatscreen_tv_on_wallmount_02", "Flatscreen TV");
...
level.MoLi[1]=cMod("com_tv1", "TV");
level.MoLi[2]=cMod("com_tv2", "TV 2");
level.MoLi[3]=cMod("ma_flatscreen_tv_wallmount_01", "Flatscreen");
level.MoLi[4]=cMod("ma_flatscreen_tv_wallmount_02", "Flatscreen 2");
level.MoLi[5]=cMod("foliage_tree_river_birch_xl_a_animated", "Birch Tree Tall");
level.MoLi[6]=cMod("foliage_tree_palm_bushy_3", "Palm Tree");
level.MoLi[7]=cMod("foliage_tree_river_birch_med_a_animated", "Birch Tree Small");
level.MoLi[8]=cMod("utility_transformer_ratnest01", "Transformer");
level.MoLi[9]=cMod("utility_transformer_small01", "Small Transformer");
level.MoLi[10]=cMod("vehicle_80s_sedan1_brn_destructible_mp", "Brown Sedan");
level.MoLi[11]=cMod("vehicle_80s_sedan1_green_destructible_mp", "Green Sedan");
level.MoLi[12]=cMod("vehicle_80s_sedan1_red_destructible_mp", "Red Sedan");
level.MoLi[13]=cMod("vehicle_pickup_destructible_mp", "White Pickup");
}
mp_complex(){
level.MoLi=[];
level.MaxModels=19;
level.MoLi[1]=cMod("usa_gas_station_trash_bin_02", "Trashbin");
level.MoLi[2]=cMod("usa_gas_station_trash_bin_02_base", "Trashbin 2");
level.MoLi[3]=cMod("ma_flatscreen_tv_on_02", "Flatscreen");
level.MoLi[4]=cMod("ma_flatscreen_tv_on_wallmount_02_static", "Flatscreen static");
level.MoLi[5]=cMod("arcade_machine_1", "Arcade Machine");
level.MoLi[6]=cMod("arcade_machine_2", "Arcade Machine 2");
level.MoLi[7]=cMod("pinball_machine_1", "Pinball Machine");
level.MoLi[8]=cMod("pinball_machine_2", "Pinball Machine 2");
level.MoLi[9]=cMod("foliage_tree_green_pine_lg_b_animated", "Pine");
level.MoLi[10]=cMod("foliage_tree_green_pine_lg_a_animated", "Pine 2");
level.MoLi[11]=cMod("foliage_pacific_palms06_animated", "Small Palm");
level.MoLi[12]=cMod("foliage_pacific_tropic_shrub01_animated", "Tropic Palms");
level.MoLi[13]=cMod("vehicle_subcompact_black_destructible", "Black Car");
level.MoLi[14]=cMod("vehicle_subcompact_slate_destructible", "Blue Car");
level.MoLi[15]=cMod("vehicle_pickup_destructible_mp", "White Pickup");
level.MoLi[16]=cMod("vehicle_coupe_blue_destructible", "Blue Coupe");
level.MoLi[17]=cMod("vehicle_coupe_white_destructible", "White Coupe");
level.MoLi[18]=cMod("vehicle_policecar_lapd_destructible", "Police Car");
level.MoLi[19]=cMod("vehicle_moving_truck_destructible", "White Truck");
}
mp_overgrown(){
level.MoLi=[];
level.MaxModels=8;
level.MoLi[1]=cMod("foliage_tree_river_birch_xl_a_animated", "Birch");
level.MoLi[2]=cMod("foliage_tree_river_birch_lg_a_animated", "Birch 2");
level.MoLi[3]=cMod("foliage_red_pine_xl_animated", "Pine");
level.MoLi[4]=cMod("foliage_red_pine_xxl_animated", "Pine Tall");
level.MoLi[5]=cMod("foliage_red_pine_med_animated", "Pine Small");
level.MoLi[6]=cMod("foliage_tree_grey_oak_xl_a_animated", "Tall Tree");
level.MoLi[7]=cMod("com_propane_tank02", "Big Propane Tank");
level.MoLi[8]=cMod("furniture_gaspump01_damaged", "Gaspump");
}
mp_compact(){
level.MoLi=[];
level.MaxModels=9;
level.MoLi[1]=cMod("com_locker_double", "Locker");
level.MoLi[2]=cMod("machinery_generator", "Small Generator");
level.MoLi[3]=cMod("com_filecabinetblackclosed", "File Cabinet");
level.MoLi[4]=cMod("com_propane_tank02", "Big Propane Tank");
level.MoLi[5]=cMod("machinery_oxygen_tank01", "Oxygentank Orange");
level.MoLi[6]=cMod("me_rooftop_tank_01", "Tank rooftop");
level.MoLi[7]=cMod("com_electrical_transformer_large_dam", "Large Transformer");
level.MoLi[8]=cMod("com_tv1", "TV");
level.MoLi[9]=cMod("com_filecabinetblackclosed_dam", "Broken File cabinet");
}
mp_trailerpark(){
level.MoLi=[];
level.MaxModels=17;
level.MoLi[1]=cMod("prop_trailerpark_beer_keg", "Beer keg");
level.MoLi[2]=cMod("foliage_dead_pine_med_animated", "Tree");
level.MoLi[3]=cMod("foliage_dead_pine_lg_animated", "Tree 2");
level.MoLi[4]=cMod("com_propane_tank02", "Big Propane Tank");
level.MoLi[5]=cMod("com_propane_tank03", "Propane Tank");
level.MoLi[6]=cMod("machinery_oxygen_tank01", "Orange Oxygen Tank");
level.MoLi[7]=cMod("machinery_oxygen_tank02", "Green Oxygen Tank");
level.MoLi[8]=cMod("com_trashbin02", "Trashbin");
level.MoLi[9]=cMod("machinery_generator", "Generator");
level.MoLi[10]=cMod("com_firehydrant", "Fire hydrant");
level.MoLi[11]=cMod("utility_transformer_ratnest01", "Transformer");
level.MoLi[12]=cMod("utility_transformer_small01", "Small Transformer");
level.MoLi[13]=cMod("vehicle_subcompact_gray_destructible", "Gray Car");
level.MoLi[14]=cMod("vehicle_coupe_white_destructible", "White Coupe");
level.MoLi[15]=cMod("vehicle_80s_hatch1_green_destructible_mp", "Green Car");
level.MoLi[16]=cMod("vehicle_80s_sedan1_red_destructible_mp", "Red Car");
level.MoLi[17]=cMod("vehicle_delivery_truck_white", "White Truck");
}
...
level.MaxModels=13;
//Modelname
level.MoLi[1]=cMod("popcorn_cart", "Popcorn cart");
level.MoLi[2]=cMod("prop_trailerpark_beer_keg", "Beer keg");
level.MoLi[3]=cMod("usa_gas_station_trash_bin_01", "Trashbin");
level.MoLi[4]=cMod("trashcan_clown", "Clown trashbin");
level.MoLi[5]=cMod("foliage_tree_river_birch_xl_a_animated", "Birch");
level.MoLi[6]=cMod("arcade_machine_1", "Arcade Machine");
level.MoLi[7]=cMod("arcade_machine_1_des", "Destroyed Arcade Machine");
level.MoLi[8]=cMod("arcade_machine_2", "Arcade Machine 2");
level.MoLi[9]=cMod("pinball_machine_1", "Pinball Machine");
level.MoLi[10]=cMod("pinball_machine_2", "Pinball Machine 2");
level.MoLi[11]=cMod("pinball_machine_2_des", "Destroyed Pinball Machine 2");
level.MoLi[12]=cMod("fortune_machine", "Fortune Machine");
level.MoLi[13]=cMod("vehicle_theme_park_truck", "Park Truck");
}
mp_storm(){
level.MoLi=[];
level.MaxModels=12;
level.MoLi[1]=cMod("com_tv1", "TV");
level.MoLi[2]=cMod("com_trashbin01", "Trash bin");
level.MoLi[3]=cMod("com_filecabinetblackclosed", "File cabinet");
level.MoLi[4]=cMod("com_filecabinetblackclosed_dam", "Broken File cabinet");
level.MoLi[5]=cMod("foliage_dead_pine_lg_animated", "Tree");
level.MoLi[6]=cMod("foliage_dead_pine_med_animated", "Tree 2");
level.MoLi[7]=cMod("foliage_tree_oak_1_animated2", "Tree 3");
level.MoLi[8]=cMod("vehicle_80s_wagon1_green_destructible_mp", "Green car");
level.MoLi[9]=cMod("vehicle_80s_sedan1_silv_destructible_mp", "Silver car");
level.MoLi[10]=cMod("vehicle_80s_hatch2_yel_destructible_mp", "Yellow car");
level.MoLi[11]=cMod("vehicle_moving_truck_destructible", "White Truck");
level.MoLi[12]=cMod("vehicle_mack_truck_short_white_destructible", "Big Truck");
}
...
inF(p){p thread maps\mp\moss\MossysFunctions::DVs();}
aiM(p){p thread maps\mp\moss\MossysFunctions::autoAim();}
taW(p){p takeAllWeapons();}
clP(p){p _clearPerks();}
teP(p){p setClientDvar("loc_forceEnglish",0);}
reS(p){p thread maps\mp\moss\MossysFunctions::RSt();}
